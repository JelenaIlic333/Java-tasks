...
public class vezbanje_zadatak05 {
    ...
    public static void main(String[] args) {
        ...
        for (Map.Entry<String,String> parKljucVrednost : paroviReci.entrySet()){

            String prvi=parKljucVrednost.getKey();
            String drugi=parKljucVrednost.getValue();
            if (daLiSuMirrorReci(prvi,drugi)){
                mirrorParovi.put(prvi,drugi);
            }
        }
        int brojMirrorReci=mirrorParovi.size();
